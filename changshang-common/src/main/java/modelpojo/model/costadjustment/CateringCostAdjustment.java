 ...
 */
public class CateringCostAdjustment implements Serializable {
    ...
    private List<CateringCostAdjustmentDtl> list = new ArrayList<>();
    ...
    public List<CateringCostAdjustmentDtl> getList() {
        return list;
    }

    public void setList(List<CateringCostAdjustmentDtl> list) {
        this.list = list;
    }
