...
public class CateringWhRcptRtnBillModel implements Serializable {
    ...
    private Integer paymentdaysIdReceive; // '领用账期id',

    private Integer paymentdaysIdReturn; // '归还账期id',

    private Date paymentdaysDateReceive; //'领用账期日期',

    private Date paymentdaysDateReturn; //'归还账期日期',

    public Integer getPaymentdaysIdReceive() {
        return paymentdaysIdReceive;
    }

    public void setPaymentdaysIdReceive(Integer paymentdaysIdReceive) {
        this.paymentdaysIdReceive = paymentdaysIdReceive;
    }

    public Integer getPaymentdaysIdReturn() {
        return paymentdaysIdReturn;
    }

    public void setPaymentdaysIdReturn(Integer paymentdaysIdReturn) {
        this.paymentdaysIdReturn = paymentdaysIdReturn;
    }

    public Date getPaymentdaysDateReceive() {
        return paymentdaysDateReceive;
    }

    public void setPaymentdaysDateReceive(Date paymentdaysDateReceive) {
        this.paymentdaysDateReceive = paymentdaysDateReceive;
    }

    public Date getPaymentdaysDateReturn() {
        return paymentdaysDateReturn;
    }

    public void setPaymentdaysDateReturn(Date paymentdaysDateReturn) {
        this.paymentdaysDateReturn = paymentdaysDateReturn;
    }
