 ...
 * @Description 原材料税率调整单
 * @author: huangpeng
 * @date:2021/2/23 17:11
 */
public class CateringPhTax implements Serializable {
     ...
     * 调整单详情集合
     */
    private List<CateringPhTaxDtl> list = new ArrayList<>();
    ...
    public List<CateringPhTaxDtl> getList() {
        return list;
    }

    public void setList(List<CateringPhTaxDtl> list) {
        this.list = list;
    }
