...
public class CateringRedSemiPdtBillDtl implements Serializable{
    ...
    private BigDecimal redDashedNum;//红冲数量

    public BigDecimal getRedDashedNum() {
        return redDashedNum;
    }

    public void setRedDashedNum(BigDecimal redDashedNum) {
        this.redDashedNum = redDashedNum;
    }
    ...
    private List<CateringRedSemiPdtBomDtl> cateringRedSemiPdtBomDtlList;

    public List<CateringRedSemiPdtBomDtl> getCateringRedSemiPdtBomDtlList() {
        return cateringRedSemiPdtBomDtlList;
    }

    public void setCateringRedSemiPdtBomDtlList(List<CateringRedSemiPdtBomDtl> cateringRedSemiPdtBomDtlList) {
        this.cateringRedSemiPdtBomDtlList = cateringRedSemiPdtBomDtlList;
    }
