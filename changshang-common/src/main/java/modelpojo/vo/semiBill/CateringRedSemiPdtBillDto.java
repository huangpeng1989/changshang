...
public class CateringRedSemiPdtBillDto extends CateringRedSemiPdtBill {
    ...
    private List<CateringRedSemiPdtBillDtl> list;

    public List<CateringRedSemiPdtBillDtl> getList() {
        return list;
    }

    public void setList(List<CateringRedSemiPdtBillDtl> list) {
        this.list = list;
    }
