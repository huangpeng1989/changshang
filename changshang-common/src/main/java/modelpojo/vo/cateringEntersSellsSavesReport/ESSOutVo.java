...
public class ESSOutVo implements Serializable{
	
	 /**
	 * 
	 */
	private static final long serialVersionUID = 4248752438815831234L;
	private String comName;// 原材料名称
	...
	private BigDecimal tranTaxCost   ;//转换含税成本

	private BigDecimal tranNoTaxCost;//转换未税成本

	private BigDecimal proccCount    ;//本期加工总数

	private BigDecimal proccTaxCost    ;//加工含税成本

	private BigDecimal proccNoTaxCost;//加工未税成本
