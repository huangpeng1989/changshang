 ...
 * 售价调价子表
 */
public class CommodityTcjSaleadjustdetailVo implements Serializable {
    //状态
    ...
    //原毛利率
    private String oGroMargin;
    //新毛利率
    private String newGroMargin;
    //商品规格单位
    ...
    public String getoGroMargin() {
        return oGroMargin;
    }

    public void setoGroMargin(String oGroMargin) {
    ...
    public String getNewGroMargin() {
        return newGroMargin;
    }

    public void setNewGroMargin(String newGroMargin) {
